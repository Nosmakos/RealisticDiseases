package me.nosmakos.borndisease.data;
...
public class UserData extends YamlConfiguration {
    ...
    public static UserData getConfig(BornDisease plugin, OfflinePlayer player) {
    ...
    private UserData(BornDisease plugin, OfflinePlayer player) {
        super();
        this.player = player;
